...
const TopFilms = ({data}:FilmsbygenreProps) => {
...
export async function getServerSideProps(context:any) {
  ...
  const response = await fetch(`https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&page=1&api_key=533c699d20160f1793f6b6802001b0ed`)
